...
from ..scripts.analysis.resource import (
    ResourceAnalyzer,
...
class TestResourceAnalyzer:
    ...
    def test_recursive_analysis(self, temp_component_dir, sample_netlist):
        ...
        analyzer = ResourceAnalyzer("test_component", config, base_dir=str(temp_component_dir))
    ...
    def test_environment_setup(self, temp_component_dir):
        ...
        with patch("subprocess.run") as mock_run:
            ...
            assert calls[1] == call(["yosys", "--version"], capture_output=True)
