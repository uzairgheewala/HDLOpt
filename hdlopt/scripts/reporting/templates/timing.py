...
class TimingTemplate(PageTemplate):
    ...
    def _add_timing_visualizations(self, timing_data):
        ...
        if timing_data['timing_summary']:
            try:
                ...
                self.add_element(Paragraph(f"Error generating visualization: {str(e)}", 
    ...
    def _add_slack_distribution_plot(self, summary):
        ...
        try:
            ...
            logger.error(f"Failed to generate slack distribution plot: {str(e)}")
            self.add_element(Paragraph(f"Error generating slack distribution visualization: {str(e)}", 
                                    self.styles['BodyText']))
    ...
    def _add_clock_comparison_plot(self, clock_summary):
        ...
        try:
            ...
            self.add_element(Paragraph(f"Error generating clock comparison visualization: {str(e)}", 
                                    self.styles['BodyText']))
