...
from reportlab.platypus import Table, TableStyle, Spacer, Image, Paragraph, Flowable, PageBreak
...
class SchematicTemplate(PageTemplate):
    ...
    def generate_page(self, 
                     ...
                     annotations: Optional[List[SchematicAnnotation]] = None) -> None:
    ...
    def _add_info_section(self, tool_name: str, metrics: Optional[SchematicMetrics]) -> None:
        """Add schematic info and metrics section."""
        # Tool info
        self.add_heading("Schematic Information", level=2)
        
        tool_info = [[
            "Generation Tool", tool_name
        ]]
    ...
    def _add_schematic_image(self, 
        ...
        try:
            ...
            if annotations:
                self.add_element(Paragraph("Annotation Details:", self.styles['BodyText']))
                for ann in annotations:
    ...
    def _add_hierarchy_view(self, schematic_path: Path, component_name: str) -> None:
        ...
        try:
            ...
            if not source_v.exists():
                raise FileNotFoundError(f"{source_v} not found, cannot generate hierarchy.")
