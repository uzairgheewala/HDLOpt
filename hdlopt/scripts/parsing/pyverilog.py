...
try:
    ...
    from pyverilog.vparser.ast import (
        ...
        Wire, Reg, Parameter, Decl, Ioport, Input, Output, 
        Inout, Identifier
    )
...
class PyVerilogParser(VerilogParserBase):
    ...
    def parse_signal(self, declaration: str, comment: str = "", parameters: List[Dict[str, str]] = None, is_input: bool = False) -> Optional[Signal]:
