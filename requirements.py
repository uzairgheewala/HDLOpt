...
def install_dependencies():
    ...
    subprocess.run(["pip", "install", "pyvips", "fusesoc", "jinja2", "ply", "pyverilog", "numpy", "pandas", "matplotlib", "deap", "cocotb", "simpy", "vunit-hdl", "networkx", "pyreadline3", "ipython-genutils", "reportlab", "pymupdf", "pyverilog"])
